...
class Command(BaseCommand):
    help = "Импортирует legacy device_slot_entitlements в INFINDA."
    ...
    def handle(self, *args, **options):
        ...
        summary = import_amonora_device_slot_entitlements(
        ...
        self.stdout.write(f"source_entitlements={summary.source_entitlements}")
        self.stdout.write(f"updated_subscriptions={summary.updated_subscriptions}")
