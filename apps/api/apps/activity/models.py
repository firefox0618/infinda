...
class UserActivity(models.Model):
    class Action(models.TextChoices):
        ...
        PUBLIC_SUBSCRIPTION_TOUCHED = "public_subscription_touched", "Публичное касание подписки"
        VPN_DEVICE_SLOT_UPDATED = "vpn_device_slot_updated", "Обновление лимита устройств VPN"
        VPN_REPAIR_EVENT = "vpn_repair_event", "Событие ремонта VPN"
